...
<div class="container py-5">
    ...
    <div class="text-center mb-5">
        <h2 class="fw-bold text-primary">Upload & Analyse Image</h2>
        ...
        @elseif ($hasDiseases)
            ...
            <script>
                (function(){
                    ...
                    console.log('Has maladies array:', analysis && analysis.maladies && Array.isArray(analysis.maladies));
                    if (analysis && analysis.maladies) {
                        console.log('Maladies count:', analysis.maladies.length);
                        console.log('First maladie:', analysis.maladies[0]);
                    }
