...
@section('content')
<div class="container">
    <h2>Diagnose Maladies by Symptômes</h2>
    <form method="POST" action="{{ route('front.maladie.match') }}">
        @csrf
        <label for="asymptome-search" class="form-label fw-bold">Rechercher un symptôme</label>
        <input type="text" class="form-control mb-3" onkeyup="searchFunction()" id="asymptome-search" placeholder="Rechercher...">
