...
<div class="modal fade" id="resultsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-gradient text-white" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                <div class="d-flex align-items-center">
                    <i class="bi bi-heart-pulse me-3" style="font-size: 1.8rem;"></i>
                    <div>
                        <h4 class="modal-title mb-0 fw-bold">Résultats de Diagnostic</h4>
            ...
            <div class="modal-body p-4">
                ...
                <div class="results-content d-none">
...
<script>
    ...
    // Handle form submission and show results in modal
    document.querySelector('form[method="POST"]').addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            // In a real application, you would fetch results via AJAX
            // For now, we'll use the existing results if they exist
            @if(isset($results) && count($results) > 0)
                populateResultsTable(@json($results));
