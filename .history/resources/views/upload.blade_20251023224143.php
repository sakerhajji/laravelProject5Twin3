        ...
        <script>
            (function(){
                ...
                function getMaladies(data) {
                    console.log('getMaladies input:', data);
                    ...
                    if (data.maladies && Array.isArray(data.maladies)) {
                        console.log('Found maladies array:', data.maladies);
                        return data.maladies;
                    }
                    
                    if (data.content && Array.isArray(data.content)) {
                        console.log('Found content array:', data.content);
                        return data.content;
                    }
                    
                    if (typeof data === 'string') {
                        console.log('Data is string, attempting parse:', data);
                        try {
                    ...
                    // If we reach here, log what we got
                    console.log('No valid maladies found in:', data);
                    return [];
                }
