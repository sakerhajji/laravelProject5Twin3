        ...
        try {
            ...
            try {
                ...
                if (isset($analysis['success']) && $analysis['success']) {
                    ...
                    \Log::debug('OpenRouter content:', ['content' => $content]);
                    
                    if (is_string($content)) {
                        $decoded = json_decode($content, true);
                        \Log::debug('Decoded content:', ['decoded' => $decoded, 'error' => json_last_error_msg()]);
                        ...
                        if (json_last_error() === JSON_ERROR_NONE && isset($decoded['maladies'])) {
                            ...
                            $analysisResult = ['error' => 'Invalid response format from AI service'];
                        }
                    } else {
